...
<script>
  ...
  import {CateForm} from "../../network/users"
  ...
  export default {
    ...
    methods: {
      // 获取所有的商品分类列表
      async getCateList() {
        const {data: res} = await this.$http.get('http://timemeetyou.com:8889/api/private/v1/categories')
      ...
      async getParamsData() {
        ...
        const {data: res} = await this.$http.get(
          `http://timemeetyou.com:8889/api/private/v1/categories/${this.cateId}/attributes`,
          {
      ...
      async showEditDialog(attrId) {
        // 查询当前参数的信息
        const {data: res} = await this.$http.get(
          `http://timemeetyou.com:8889/api/private/v1/categories/${this.cateId}/attributes/${attrId}`,
          {
      ...
      editParams() {
        this.$refs.editFormRef.validate(async valid => {
          ...
          const {data: res} = await this.$http.put(
            `http://timemeetyou.com:8889/api/private/v1/categories/${this.cateId}/attributes/${this.editForm.attr_id}`,
      ...
      async saveAttrVals(row) {
        // 需要发起请求，保存这次操作
        const {data: res} = await this.$http.put(
          `http://timemeetyou.com:8889/api/private/v1/categories/${this.cateId}/attributes/${row.attr_id}`,
          {
